# W5 LC List: Graph Week, Sep 21-27, 2026 (24 NEW + 4 resolves)
...
| Day | Problems |
| :-- | :-- |
| Mon 21 | Done: Cheapest Flights, Word Ladder. Then buckets 1 and 2 (four grid problems, two Easy warm-ups) |
| Tue 22 | Bucket 3: union-find (2 Medium, 2 Hard) |
| Wed 23 | Buckets 4 and 5: Open The Lock, Path with Minimum Effort, Swim In Rising Water |
| Thu 24 | Bucket 6 (MST) plus Course Schedule IV and Minimum Height Trees |
| Fri 25 | Alien Dictionary, Parallel Courses III, then REVISE: Course Schedule, Course Schedule II |
| Sat 26 | Build a Matrix With Conditions, Sort Items by Groups, Reconstruct Itinerary |
| Sun 27 | Word Ladder II, Optimal Account Balancing, then REVISE: Evaluate Division, Number of Provinces |
