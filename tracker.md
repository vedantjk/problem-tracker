...
**Progress:** 140 Solved · most recent: *Walls And Gates* (21/09/2026). **W2 LC CLOSED 18/18. W3 (Sep 7-13) slipped, 0 solved; list carried into W4 (Sep 14-20), which closed at 6/22; the remaining 16 carried into W5 (Sep 21-27). W5 = graph week: 2 solved from the carried list plus the 24-problem graph list in `w5_lc_list.md`, 6/26. The other 14 carried problems (DP, Backtracking, Trees, wildcards) move to W6.**
