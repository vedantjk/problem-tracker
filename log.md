...
| 2026-08-29 | Saturday | 0 | No | — | W1 day 3. No LC (webcam pair slipped to Sun). getcracked Beginner C++: 10 nodes, 10 Q, 0 missed; notes started in `cpp/` (10 files). Tree progress 80/498 (16%). |
