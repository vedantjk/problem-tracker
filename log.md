...
| 2026-08-27 | Thursday | 2 | Yes | — | getcracked W1 day 1. Contains Duplicate (hash set vs sort) + Valid Anagram (26-count array, single-array ++/-- variant, const& / std::array notes). Plan: plans/W1.md. |
| 2026-08-28 | Friday | 8 | Yes | — | 🔥 W1 day 2: Top K Frequent (bucket sort), Longest Consecutive (iterate the set!), Valid Palindrome (unsigned char), 3Sum (one dup-skip suffices), Container With Most Water (proof), Longest Substring w/o Repeating (last-seen array), Linked List Cycle, Kth Largest (quickselect/nth_element). 10/14 for W1; Sat = webcam pair, Sun = Reverse LL + Rotated Search. |
| 2026-08-29 | Saturday | 0 | No | — | W1 day 3. No LC (webcam pair slipped to Sun). getcracked Beginner C++: 10 nodes, 10 Q, 0 missed; notes started in `cpp/` (10 files). Tree progress 80/498 (16%). Beginner C++ quiz baseline 11/20 in 18 min, top 9.7%, coding Qs skipped. |
