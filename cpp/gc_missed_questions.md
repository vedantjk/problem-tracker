# Beginner C++ tree: missed questions (scraped 2026-09-24 evening)
...
## Bitwise Operators and Bit Masks (1)
- [ ] [Down shift](https://getcracked.io/question/1102) (Medium)

## Pre and Post Decrement (2)
...
## lvalue, rvalue, xvalue, prvalue, glvalue (1)
...
## Constant and Constexpr Variables (3)
...
## Const Classes and Functions & Access Specifiers (1)
- [ ] [Drop these.](https://getcracked.io/question/1066) (Medium)

## Special Member Functions (7)
...
## std::unordered_map & std::map (1)
- [ ] [Wrong map, bro.](https://getcracked.io/question/1003) (Hard)

## std::set & std::unordered_set (2)
...
## Templates: Classes (1)
- [ ] [To <T> or not to <T>](https://getcracked.io/question/690) (Easy)

## Class Template Argument Deduction (1)
- [ ] [A template, or not not?](https://getcracked.io/question/686) (Medium)
